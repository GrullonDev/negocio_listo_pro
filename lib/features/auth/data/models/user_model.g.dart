...
const UserModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'fixedSessionId': PropertySchema(
      id: 3,
      name: r'fixedSessionId',
      type: IsarType.long,
    ),
  ...
  idName: r'id',
  indexes: {
    r'fixedSessionId': IndexSchema(
      id: 4230722766744606538,
      name: r'fixedSessionId',
      unique: true,
      replace: true,
      properties: [
...
void _userModelSerialize(
  ...
  writer.writeLong(offsets[3], object.fixedSessionId);
...
UserModel _userModelDeserialize(
  ...
  object.fixedSessionId = reader.readLong(offsets[3]);
  object.id = id;
  object.tenant =
...
extension UserModelByIndex on IsarCollection<UserModel> {
  Future<UserModel?> getByFixedSessionId(int fixedSessionId) {
    return getByIndex(r'fixedSessionId', [fixedSessionId]);
  }

  UserModel? getByFixedSessionIdSync(int fixedSessionId) {
    return getByIndexSync(r'fixedSessionId', [fixedSessionId]);
  }

  Future<bool> deleteByFixedSessionId(int fixedSessionId) {
    return deleteByIndex(r'fixedSessionId', [fixedSessionId]);
  }

  bool deleteByFixedSessionIdSync(int fixedSessionId) {
    return deleteByIndexSync(r'fixedSessionId', [fixedSessionId]);
  }

  Future<List<UserModel?>> getAllByFixedSessionId(
    List<int> fixedSessionIdValues,
  ) {
    final values = fixedSessionIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'fixedSessionId', values);
  }

  List<UserModel?> getAllByFixedSessionIdSync(List<int> fixedSessionIdValues) {
    final values = fixedSessionIdValues.map((e) => [e]).toList();
    return getAllByIndexSync(r'fixedSessionId', values);
  }

  Future<int> deleteAllByFixedSessionId(List<int> fixedSessionIdValues) {
    final values = fixedSessionIdValues.map((e) => [e]).toList();
    return deleteAllByIndex(r'fixedSessionId', values);
  }

  int deleteAllByFixedSessionIdSync(List<int> fixedSessionIdValues) {
    final values = fixedSessionIdValues.map((e) => [e]).toList();
    return deleteAllByIndexSync(r'fixedSessionId', values);
  }

  Future<Id> putByFixedSessionId(UserModel object) {
    return putByIndex(r'fixedSessionId', object);
  }

  Id putByFixedSessionIdSync(UserModel object, {bool saveLinks = true}) {
    return putByIndexSync(r'fixedSessionId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByFixedSessionId(List<UserModel> objects) {
    return putAllByIndex(r'fixedSessionId', objects);
  }

  List<Id> putAllByFixedSessionIdSync(
    List<UserModel> objects, {
    bool saveLinks = true,
  }) {
    return putAllByIndexSync(r'fixedSessionId', objects, saveLinks: saveLinks);
  }
}
...
extension UserModelQueryWhereSort
  ...
  QueryBuilder<UserModel, UserModel, QAfterWhere> anyFixedSessionId() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        const IndexWhereClause.any(indexName: r'fixedSessionId'),
      );
    });
  }
}
...
extension UserModelQueryWhere
  ...
  QueryBuilder<UserModel, UserModel, QAfterWhereClause> fixedSessionIdEqualTo(
    int fixedSessionId,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IndexWhereClause.equalTo(
          indexName: r'fixedSessionId',
  ...
  fixedSessionIdNotEqualTo(int fixedSessionId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(
  ...
  QueryBuilder<UserModel, UserModel, QAfterWhereClause>
  fixedSessionIdGreaterThan(int fixedSessionId, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IndexWhereClause.between(
          indexName: r'fixedSessionId',
  ...
  QueryBuilder<UserModel, UserModel, QAfterWhereClause> fixedSessionIdLessThan(
    int fixedSessionId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserModel, UserModel, QAfterWhereClause> fixedSessionIdBetween(
    int lowerFixedSessionId,
    int upperFixedSessionId, {
    bool includeLower = true,
    bool includeUpper = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IndexWhereClause.between(
          indexName: r'fixedSessionId',
          lower: [lowerFixedSessionId],
          includeLower: includeLower,
          upper: [upperFixedSessionId],
          includeUpper: includeUpper,
        ),
      );
    });
...
extension UserModelQueryFilter
  ...
  QueryBuilder<UserModel, UserModel, QAfterFilterCondition> authTokenEqualTo(
    String value, {
  ...
  QueryBuilder<UserModel, UserModel, QAfterFilterCondition> authTokenLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<UserModel, UserModel, QAfterFilterCondition> authTokenBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<UserModel, UserModel, QAfterFilterCondition> authTokenStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserModel, UserModel, QAfterFilterCondition> authTokenEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserModel, UserModel, QAfterFilterCondition> authTokenContains(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserModel, UserModel, QAfterFilterCondition> authTokenMatches(
    String pattern, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserModel, UserModel, QAfterFilterCondition> authTokenIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<UserModel, UserModel, QAfterFilterCondition>
  fixedSessionIdEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'fixedSessionId', value: value),
      );
    });
  }

  QueryBuilder<UserModel, UserModel, QAfterFilterCondition>
  fixedSessionIdGreaterThan(int value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(
          include: include,
          property: r'fixedSessionId',
          value: value,
        ),
      );
    });
  ...
  QueryBuilder<UserModel, UserModel, QAfterFilterCondition>
  fixedSessionIdLessThan(int value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.lessThan(
          include: include,
...
extension UserModelQueryObject
    on QueryBuilder<UserModel, UserModel, QFilterCondition> {
  QueryBuilder<UserModel, UserModel, QAfterFilterCondition> tenant(
...
extension UserModelQuerySortBy on QueryBuilder<UserModel, UserModel, QSortBy> {
  QueryBuilder<UserModel, UserModel, QAfterSortBy> sortByAuthToken() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'authToken', Sort.asc);
    });
  }

  QueryBuilder<UserModel, UserModel, QAfterSortBy> sortByAuthTokenDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserModel, UserModel, QAfterSortBy> sortByFixedSessionId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'fixedSessionId', Sort.asc);
    });
  }

  QueryBuilder<UserModel, UserModel, QAfterSortBy> sortByFixedSessionIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'fixedSessionId', Sort.desc);
    });
  }
...
extension UserModelQuerySortThenBy
  ...
  QueryBuilder<UserModel, UserModel, QAfterSortBy> thenByAuthToken() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'authToken', Sort.asc);
    });
  }

  QueryBuilder<UserModel, UserModel, QAfterSortBy> thenByAuthTokenDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'authToken', Sort.desc);
    });
  }
  ...
  QueryBuilder<UserModel, UserModel, QAfterSortBy> thenByFixedSessionId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'fixedSessionId', Sort.asc);
    });
  }

  QueryBuilder<UserModel, UserModel, QAfterSortBy> thenByFixedSessionIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'fixedSessionId', Sort.desc);
    });
  }
...
extension UserModelQueryWhereDistinct
  ...
  QueryBuilder<UserModel, UserModel, QDistinct> distinctByAuthToken({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserModel, UserModel, QDistinct> distinctByFixedSessionId() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'fixedSessionId');
    });
  }
...
extension UserModelQueryProperty
  ...
  QueryBuilder<UserModel, String, QQueryOperations> authTokenProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserModel, int, QQueryOperations> fixedSessionIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'fixedSessionId');
    });
  }

  QueryBuilder<UserModel, TenantModel, QQueryOperations> tenantProperty() {
    return QueryBuilder.apply(this, (query) {
